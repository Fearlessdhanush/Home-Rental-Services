...
function insert() {
    ...
    if (move_uploaded_file($image["tmp_name"], $target_file)) {
        ...
        $query = "INSERT INTO propertyinfo (id, bedrooms, location, price, availability, description, photo) VALUES ('$id', '$bedrooms', '$location', '$price', '$availability', '$description', '$target_file')";
        ...
        echo "Error Code: " . $image["error"] . "<br>";
    }
}
?>
